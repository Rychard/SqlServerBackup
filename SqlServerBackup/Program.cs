	...
	internal class Program
	{
		...
		private static void Main(string[] args)
		{
			...
			if (!settingsFileExists)
			{
				...
				Console.WriteLine("A default settings file has been generated.  It can be found at the following location:{0}\t{1}", Environment.NewLine, settingsFile);
			...
			try
			{
				...
				_settings = JsonConvert.DeserializeObject<Settings>(settingsFileContents);
			}
			catch (Exception ex)
			{
